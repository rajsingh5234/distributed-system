...
describe('POST /users', () => {
    ...
    describe('Given all fields', () => {
        ...
        it('should create user with MANAGER role', async () => {
            // Arrange
            const user = { firstName: 'John', lastName: 'Doe', email: 'john@example.com', password: 'password123', role: UserRole.MANAGER };
        ...
        it('should create user with CUSTOMER role', async () => {
            // Arrange
            const user = { firstName: 'John', lastName: 'Doe', email: 'john@example.com', password: 'password123', role: UserRole.CUSTOMER };
    ...
    describe('Fields are missing', () => {
        ...
        it('should return 400 if firstName is missing', async () => {
            // Arrange
            const user = { lastName: 'Doe', email: 'john@example.com', password: 'password123' };
        ...
        it('should return 400 if lastName is missing', async () => {
            // Arrange
            const user = { firstName: 'John', email: 'john@example.com', password: 'password123' };
        ...
        it('should return 400 if email is missing', async () => {
            // Arrange
            const user = { firstName: 'John', lastName: 'Doe', password: 'password123' };
    ...
    describe('Fields are not in proper format', () => {
        ...
        it('should return 400 if firstName is empty string', async () => {
            // Arrange
            const user = { firstName: '', lastName: 'Doe', email: 'john@example.com', password: 'password123' };
        ...
        it('should return 400 if lastName is empty string', async () => {
            // Arrange
            const user = { firstName: 'John', lastName: '', email: 'john@example.com', password: 'password123' };
        ...
        it('should return 400 if email is not valid format', async () => {
            // Arrange
            const user = { firstName: 'John', lastName: 'Doe', email: 'not-an-email', password: 'password123' };
        ...
        it('should return 400 if role is admin', async () => {
            // Arrange
            const user = { firstName: 'John', lastName: 'Doe', email: 'john@example.com', password: 'password123', role: UserRole.ADMIN };
        ...
        it('should return 400 if password is less than 8 characters', async () => {
            // Arrange
            const user = { firstName: 'John', lastName: 'Doe', email: 'john@example.com', password: 'short' };
